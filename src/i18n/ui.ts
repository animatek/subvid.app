...
export const ui = {
  en: {
    ...
    projects: {
      ...
      empty: "Your saved projects will appear here.",
    },
    footer: {
    ...
    editor: {
      ...
      videoLayout: "Composition",
      layoutOriginal: "Original",
      layoutVerticalStream: "Vertical stream",
      defineCamera: "Define camera",
      defineScreen: "Define screen",
      verticalPreview: "Vertical preview",
      cameraCrop: "Camera",
      screenCrop: "Screen",
      setCrop: "Set crop",
      fixedTitleOptions: "Fixed title options",
      fixedTitle: "Fixed text",
      fixedTitlePlaceholder: "Text on the vertical clip",
      fixedTitleFont: "Fixed text font",
      fixedTitlePosition: "Fixed text position",
      verticalSubsSize: "Subs size",
      verticalSubsPosition: "Subs Y",
    },
    status: {
    ...
    client: {
      ...
      projectOpened: "Project restored.",
      projectOpen: "Open",
      projectDelete: "Delete",
      projectTracks: "{n} tracks",
      projectUntitled: "Untitled project",
      importSrtEmpty: "SRT has no valid subtitles.",
      importSrtReady: "SRT imported: {n} lines.",
  ...
  es: {
    ...
    projects: {
      kicker: "Espacio local",
      title: "Proyectos recientes",
      local: "Guardados en este navegador",
      empty: "Tus proyectos guardados aparecerán aquí.",
    },
    footer: {
    ...
    editor: {
      ...
      videoLayout: "Composición",
      layoutOriginal: "Original",
      layoutVerticalStream: "Stream vertical",
      defineCamera: "Definir cámara",
      defineScreen: "Definir pantalla",
      verticalPreview: "Preview vertical",
      cameraCrop: "Cámara",
      screenCrop: "Pantalla",
      setCrop: "Establecer recorte",
      fixedTitleOptions: "Opciones de texto fijo",
      fixedTitle: "Texto fijo",
      fixedTitlePlaceholder: "Texto del clip vertical",
      fixedTitleFont: "Fuente del texto fijo",
      fixedTitlePosition: "Posición del texto fijo",
      verticalSubsSize: "Tamaño subs",
      verticalSubsPosition: "Posición subs",
    },
    status: {
    ...
    client: {
      ...
      projectSaved: "Proyecto guardado en local.",
      projectOpened: "Proyecto restaurado.",
      projectOpen: "Abrir",
      projectDelete: "Eliminar",
      projectTracks: "{n} pistas",
      projectUntitled: "Proyecto sin título",
      importSrtEmpty: "El SRT no tiene subtítulos válidos.",
      importSrtReady: "SRT importado: {n} líneas.",
